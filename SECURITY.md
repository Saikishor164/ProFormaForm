...
The Security Team publishes a public [advisory](https://github.com/saikishor164/profomaform/security/advisories) to the Harbor community via GitHub. In most cases, additional communication via Slack, Twitter, CNCF lists, blog and other channels will assist in educating Harbor users and rolling out the patched release to affected users. 
